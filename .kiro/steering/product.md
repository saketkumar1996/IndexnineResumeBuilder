...
**Indexnine Resume Builder** is a spec-driven system that generates company-compliant resumes with zero AI assistance or dynamic formatting.
...
## Target Users
Internal company tool for generating standardized resumes that comply with specific formatting and content requirements.

## Success Criteria
- All generated resumes pass ATS parsing
- 100% consistency between preview and export
- Zero validation bypasses - all rules must be satisfied